...
class TestSelf:
    ...
    def test_self_with_generics(self):
        ...
        str_container = Container()  # Type will be inferred
...
class TestUnpack:
    ...
    def test_unpack_basic_usage(self):
        ...
        # Unpack is used in type annotations, not instantiated directly
        # This test just verifies it can be imported and used syntactically
        from typing import Tuple
        
        # Test that Unpack can be used in type annotations (not instantiated)
        def process_args(*args: Unpack[Tuple[int, str, bool]]) -> int:
            return len(args)
